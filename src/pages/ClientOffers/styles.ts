...
export const UnparticipateButton = styled.button`
  background-color: #880000; // A blue background color
  color: white;
  padding: 8px 9px;
  border: none;
  border-radius: 8px;
  ...
  &:hover {
    background-color: #aa0000; // A darker blue color for the hover state
  }
`;
